...
export const navItems = [
  ...
  { key: 'dashboardpetugas', title: 'Dashboard', href: paths.dashboard.petugas, icon: 'chart-pie', roles: ['PETUGAS', 'KEPALA_PETUGAS_UNIT',''] },
  { key: 'kelolapage', title: 'Kelola', href: paths.dashboard.kelola, icon: 'users', roles: ['PETUGAS', 'KEPALA_PETUGAS_UNIT',''] },
  ...
  { key: 'add', title: 'Tambah Petugas', href: paths.dashboard.tambah, icon: 'users', roles: ['KEPALA_PETUGAS_UNIT', '',''] },
